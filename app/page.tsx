...
{/* WHO ARE YOU */}
 ...
 {/* PocketLab */}
            ...
            <div style={{ border: "2px solid #6b7280", borderRadius: 16, padding: 28, background: "#ffffff", display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <p style={{ color: "#4b5563", margin: 0, flexGrow: 1 }}>
                AI literacy shouldn&apos;t be limited to the classroom. These two volumes are for anyone who wants to understand the technology reshaping the world. This includes friends, colleagues, and yourself. Always up-to-date via print on demand. QR codes to videos are included. <em>Now available in paperback.</p>em>
              </p>
