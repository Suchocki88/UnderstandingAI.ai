        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 40, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 18, color: "#4b5563", marginBottom: 32 }}>
              For language arts teachers, we recommend taking the Conceptual Academy program as summer professional development. This will allow you to understand what students are experiencing in the Social Studies or CTE departments, and to arrive ready for the conversations these novels will spark.
            </p>
