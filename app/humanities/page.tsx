      ...
      <section style={{ background: "#f5f3ff", padding: "80px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 56, alignItems: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 18, color: "#4b5563", marginBottom: 16 }}>
              Meanwhile, the author drafted key passages himself — in his own voice — and fed these to the AI as training examples. This is why the voice feels consistent and clear. The AI was learning from a specific human mind, who happens to be a science textbook author whose instinct is always subject, verb, object. Speak the basic ideas while trusting the reader to figure out the 7/8th of the iceberg hidden underwater.
            </p>
