      ...
      <section style={{ background: "#0f172a", color: "white", padding: "80px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 20, color: "rgba(255,255,255,0.8)", marginBottom: 40 }}>
            Pricing is handled through PocketLab. Fill out the inquiry form at the bottom of the PocketLab page and the team will be in touch so that your AI literacy program can get started as soon as possible.
          </p>
