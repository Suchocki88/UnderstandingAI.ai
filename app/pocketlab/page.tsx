        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 56, alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: 18, color: "#4b5563", marginBottom: 32 }}>
              AI integration means auto-grading is built in. Alia, our AI learning assistant, is embedded with system prompt guardrais in place. Included are teacher guides, state standards alignments, and cognitive science-based teaching resources, such as novel classroom assessment techniques.
            </p>
            <a
              href="https://app.thepocketlab.com/lab-report/yyAw0siq0001yyAw?ro=1"
              target="_blank"
