        ...
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 48, alignItems: "center" }}>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <img
              ...
              alt="Frank the mascot"
              style={{ width: 260, filter: "invert(1)" }}
            />
          </div>
          <div>
            <p style={{ fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: 2, color: "#f59e0b", marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 40, margin: "0 0 24px" }}>Meet Frank</h2>
            <p style={{ fontSize: 20, color: "rgba(255,255,255,0.85)" }}>
              I know, I know. A mascot introducing itself. But I am Frank. Through Evi's art, you will find me cheering you along throughout this animal and human friendly program where you will have fun with lab experiments and in producing a creative literary work.
            </p>
            <p style={{ fontSize: 24, fontWeight: 700, color: "#f59e0b", marginTop: 24 }}>
              Ruff!
            </p>
          </div>
        </div>
